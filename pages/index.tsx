...
const Main: NextPage = () => {
  ...
  return (
    <div className="flex h-screen items-center justify-center bg-[rgb(230,0,126)]">
      <div>
        <svg
      ...
      {startBtn ? (
        <div className="fixed bottom-12 items-center justify-center">
          <a
            href="/home"
          ...
          >
            ...
            <span className="relative text-white">시작하기</span>
          </a>
        </div>
      ) : (
        <div className="fixed bottom-12">
          <svg
            className="mr-2 inline h-12 w-12 animate-spin fill-[rgb(230,0,126)] text-gray-200 dark:fill-gray-300 dark:text-[rgb(230,0,126)]"
            viewBox="0 0 100 101"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
          >
